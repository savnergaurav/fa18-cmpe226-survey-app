...
import '../Response/survey-response.css';
...
class RateQuestion extends Component {
  ...
  onStarClick(nextValue, prevValue, name) {
    this.setState({ rating: nextValue });
    this.props.onValueChange(this.props.id, (""+nextValue));
  }

  render() {
    const { responseMode, responseRate, serialNumber } = this.props;
    ...
    var rate =
      responseRate !== undefined
        ? responseRate[0].optionValue
        : this.props.questions[i].rating;
