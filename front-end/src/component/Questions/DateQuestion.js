...
class DateQuestion extends Component {
  ...
  onAnswerInput = event => {
    event.preventDefault();
    let answer = this.refs.date_input.value;
    this.props.onValueChange(this.props.id, answer);
  };

  render() {
    const { responseMode, serialNumber } = this.props;
        ...
        {responseMode && (
          ...
          >
            ...
            <div className="row" style={{ margin: "0px 15px 15px 15px" }}>
              <input type="date" ref="date_input" onChange={this.onAnswerInput} />
            </div>
          </div>
        )}
        {!responseMode && (
          ...
          >
            <div>
              ...
              <button
                onClick={e => this.handleEdit(e, this.props.id)}
                  ...
                  <div class="modal-footer">
                    ...
                    <button
                      onClick={e =>
                        this.handleUpdate(
                          e,
                          localStorage.getItem("qNumber") - 1
                        )
                      }
                      type="button"
                      data-dismiss="modal"
